					...
					<div class="banner_product_image"><img src="{{asset('files/product/'.$bannerproduct->thumbnail)}}" alt="{{$bannerproduct->name}}"></div>
					  <div class="col-lg-5 offset-lg-4 fill_height">
						<div class="banner_content">
							...
							@else
							<div class="viewd_price" ><span class="text-danger"><del>{{$setting->currency}}{{$bannerproduct->selling_price}} </del>
							</span class="text-danger"> {{$setting->currency}}{{$bannerproduct->discount_price}}</div>
							@endif
										...
										<div class="arrivals_slider_item">
											...
											<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
												...
												<div class="product_content">
													...
													@endif
													<div class="product_name"><a href="{{route('product.details',$row->slug)}}">{{substr($row->name,0,20)}}..</a></div>
													<div class="product_extras">
														<div class="product_color">
                                                            <a href="" class="quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter">quick view</a>
                                                        </div>
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						<div class="advert_content">
							<div class="advert_title"><a href="#">Trends Product</a></div>
							<div class="advert_text">This year trendy product for you</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						...
						<div class="trends_text"><p>This year trendy product</p></div>
				...
				<div class="col">
					<div class="brands_slider_container">
						...
						<div class="owl-carousel owl-theme brands_slider">
							...
							<div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="{{asset('files/brand/'.$row->brand_logo)}}" alt="{{$row->brand_name}}" width="60px" height="60px"></div></div>
							@endforeach
						</div>
