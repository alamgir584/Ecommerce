			...
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						...
						<li data-image="{{asset('/files/product/'.$row)}}"><img src="{{asset('/files/product/'.$row)}}" alt=""></li>
						@endforeach
                        @endisset
					</ul>
				</div>
				...
				<div class="col">
					<div class="brands_slider_container">
						...
						<div class="owl-carousel owl-theme brands_slider">
							...
							<div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="{{ asset('/files/brand/' . $row->brand_logo) }}"
