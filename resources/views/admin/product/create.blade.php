...
<script type="text/javascript">
  ...
  $("input[data-bootstrap-switch]").each(function(){
    ...
    $(document).ready(function(){
     ...
     //ajax request send for collect childcategory mane holo category select korle categoryr under a joto sub categorey ache se gulo asbe sob subcategory asbe na
